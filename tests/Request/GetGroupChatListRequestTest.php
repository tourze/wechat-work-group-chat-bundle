 ...
 * @internal
 */
#[CoversClass(GetGroupChatListRequest::class)]
final class GetGroupChatListRequestTest extends RequestTestCase
{
    ...
    public function testLimitWithMinValue(): void
    {
        // 测试最小值限制
        $request = new GetGroupChatListRequest();
        $request->setLimit(1);
    ...
    public function testLimitWithMaxValue(): void
    {
        // 测试最大值限制
        $request = new GetGroupChatListRequest();
    ...
    public function testStatusFilterSetterAndGetter(): void
    {
        // 测试状态过滤器设置和获取
        $request = new GetGroupChatListRequest();
    ...
    public function testStatusFilterWithNull(): void
    {
        // 测试null状态过滤器
        $request = new GetGroupChatListRequest();
    ...
    public function testOwnerUserIdsSetterAndGetter(): void
    {
        // 测试群主用户ID列表设置和获取
        $request = new GetGroupChatListRequest();
    ...
    public function testOwnerUserIdsWithEmptyArray(): void
    {
        // 测试空数组群主用户ID
        $request = new GetGroupChatListRequest();
    ...
    public function testOwnerUserIdsWithNull(): void
    {
        // 测试null群主用户ID
        $request = new GetGroupChatListRequest();
    ...
    public function testCursorWithEmptyString(): void
    {
        // 测试空字符串游标
        $request = new GetGroupChatListRequest();
        $request->setCursor('');
    ...
    public function testGetRequestOptionsWithMinimalParams(): void
    {
        ...
        $this->assertIsArray($options['json']['owner_filter']);
    ...
    public function testGetRequestOptionsWithNullStatusFilter(): void
    {
        // 测试null状态过滤器的请求选项
        $request = new GetGroupChatListRequest();
    ...
    public function testGetRequestOptionsWithNullOwnerUserIds(): void
    {
        // 测试null群主用户ID的请求选项
        $request = new GetGroupChatListRequest();
    ...
    public function testGetRequestOptionsWithEmptyOwnerUserIds(): void
    {
        // 测试空数组群主用户ID的请求选项
        $request = new GetGroupChatListRequest();
    ...
    public function testBusinessScenarioGetAllGroupChats(): void
    {
        // 测试业务场景：获取所有客户群
        $request = new GetGroupChatListRequest();
        $request->setLimit(100);
    ...
    public function testBusinessScenarioGetInheritancePendingGroups(): void
    {
        // 测试业务场景：获取离职待继承群聊
        $request = new GetGroupChatListRequest();
        $request->setLimit(50);
    ...
    public function testBusinessScenarioGetGroupsByOwner(): void
    {
        // 测试业务场景：获取特定群主的群聊
        $request = new GetGroupChatListRequest();
        $request->setLimit(200);
    ...
    public function testBusinessScenarioPaginationQuery(): void
    {
        // 测试业务场景：分页查询
        $request = new GetGroupChatListRequest();
    ...
    public function testBusinessScenarioInheritanceInProgress(): void
    {
        // 测试业务场景：继承进行中的群聊
        $request = new GetGroupChatListRequest();
        $request->setLimit(75);
    ...
    public function testBusinessScenarioInheritanceCompleted(): void
    {
        // 测试业务场景：继承完成的群聊
        $request = new GetGroupChatListRequest();
        $request->setLimit(300);
    ...
    public function testLargeUserIdsList(): void
    {
        ...
        /** @var list<literal-string&lowercase-string&non-falsy-string> $ownerUserIds */
        $ownerUserIds = $request->getOwnerUserIds();
        $this->assertCount(100, $ownerUserIds);
    ...
    public function testRequestOptionsDoesNotModifyOriginalData(): void
    {
        ...
        $this->assertArrayHasKey('owner_filter', $options1['json']);
        $this->assertIsArray($options1['json']['owner_filter']);
        ...
        $this->assertArrayHasKey('owner_filter', $options2['json']);
        $this->assertIsArray($options2['json']['owner_filter']);
    ...
    public function testImmutableBehavior(): void
    {
        ...
        $this->assertIsArray($newOptions['json']);
        $this->assertSame(123, $newOptions['json']['limit']);
        $this->assertSame(2, $newOptions['json']['status_filter']);
        $this->assertArrayHasKey('owner_filter', $newOptions['json']);
        $this->assertIsArray($newOptions['json']['owner_filter']);
