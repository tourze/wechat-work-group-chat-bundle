 ...
 * @internal
 */
#[CoversClass(GetGroupChatDetailRequest::class)]
final class GetGroupChatDetailRequestTest extends RequestTestCase
{
    ...
    public function testChatIdSetterAndGetter(): void
    {
        // 测试群聊ID设置和获取
        $request = new GetGroupChatDetailRequest();
    ...
    public function testNeedNameSetterAndGetter(): void
    {
        // 测试是否需要返回群成员名字设置和获取
        $request = new GetGroupChatDetailRequest();
    ...
    public function testNeedNameWithNull(): void
    {
    ...
    public function testRequestOptionsWithAllParameters(): void
    {
        // 测试全部参数的请求选项
        $request = new GetGroupChatDetailRequest();
    ...
    public function testRequestOptionsWithOnlyChatId(): void
    {
    ...
    public function testRequestOptionsWithNeedNameFalse(): void
    {
    ...
    public function testRequestOptionsWithNeedNameTrue(): void
    {
    ...
    public function testRequestOptionsWithNullNeedName(): void
    {
    ...
    public function testBusinessScenarioGetGroupDetailWithNames(): void
    {
        // 测试业务场景：获取群详情包含成员名字
        $request = new GetGroupChatDetailRequest();
    ...
    public function testBusinessScenarioGetBasicGroupInfo(): void
    {
    ...
    public function testBusinessScenarioSimpleGroupQuery(): void
    {
        // 测试业务场景：简单群查询（仅提供群ID）
        $request = new GetGroupChatDetailRequest();
    ...
    public function testChatIdSpecialCharacters(): void
    {
        // 测试群聊ID特殊字符
        $request = new GetGroupChatDetailRequest();
    ...
    public function testNeedNameBooleanToIntConversion(): void
    {
        // 测试needName布尔值转整数
        $request = new GetGroupChatDetailRequest();
    ...
    public function testEmptyStringChatId(): void
    {
        // 测试空字符串群聊ID
        $request = new GetGroupChatDetailRequest();
        $request->setChatId('');
    ...
    public function testBusinessScenarioCustomerServiceGroupDetail(): void
    {
        // 测试业务场景：客服群详情查询
        $request = new GetGroupChatDetailRequest();
    ...
    public function testBusinessScenarioSalesGroupAnalysis(): void
    {
        // 测试业务场景：销售群分析
        $request = new GetGroupChatDetailRequest();
    ...
    public function testBusinessScenarioGroupMemberManagement(): void
    {
        // 测试业务场景：群成员管理
        $request = new GetGroupChatDetailRequest();
